...
void PBRMaterial::DrawImGui()
{
	...
	{
		ImGui::Image((ImTextureID)(AlbedoMap.get() ? AlbedoMap->GetId() : Renderer::s_PlaceHolderTexture->GetId()), ImVec2(50.0f, 50.0f), ImVec2(0.0f, 1.0f), ImVec2(1.0f, 0.0f));
		ImGui::SameLine();
	...
	{
		ImGui::Image((ImTextureID)Renderer::s_PlaceHolderTexture->GetId(), ImVec2(50.0f, 50.0f), ImVec2(0.0f, 1.0f), ImVec2(1.0f, 0.0f));
		ImGui::SameLine();
